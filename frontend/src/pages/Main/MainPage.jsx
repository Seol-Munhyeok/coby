...
import RoomSettingsModal from '../../Common/components/RoomSettingsModal'; // RoomSettingsModal import
...
function MainPage() {
    ...
    // RoomSettingsModal에 전달할 초기 설정 상태
    ...
    return (
        <div className='MainPage'>
            <div className='min-h-screen'>
                    ...
                    <div className="flex items-center space-x-6">
                        <button className="text-blue-300 hover:text-blue-100 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 1 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                            </svg>
                        </button>
                    ...
                    <section className="mb-8">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex space-x-3">
                                <button id="openCreateRoomModal" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center transition" onClick={() => showRoomSettingsModal(true)}>
                ...
                {/* 방 만들기 모달 (RoomSettingsModal 컴포넌트 사용) */}
                <RoomSettingsModal
