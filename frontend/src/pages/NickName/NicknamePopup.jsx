...
const NicknameSetup = () => {
    ...
    const arrangeNicknameCards = () => {
        ...
        const totalWidth = cardWidth * 3 + 40;
    ...
    const handleCheckNickname = async () => {
        ...
        try {
            console.log('닉네임 중복 확인 요청:', `${process.env.REACT_APP_API_URL}/api/users/check-nickname?nickname=${trimmedNickname}`);
