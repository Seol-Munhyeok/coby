    ...
    <div className="waitingRoom-glass-effect rounded-lg p-4 flex flex-col h-full">
      ...
      <div className="flex items-center mt-3">
        <input
          ...
          id="chatInput"
          placeholder="메시지 입력..."
          className="bg-blue-900/30 text-white border border-blue-800 rounded-l-md px-3 py-2 text-sm flex-1 focus:outline-none focus:ring-1 focus:ring-blue-500"
          value={inputMessage}
          onChange={handleInputChange}
          onKeyPress={handleKeyPress}
        />
        <button id="sendChat" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-r-md transition" onClick={handleSendClick}>
